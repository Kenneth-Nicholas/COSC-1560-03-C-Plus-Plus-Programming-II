// Chapter 8 - Programming Challenge 17, Theatre Ticket Sales
// This program creates and uses a TicketManager class to handle ticket 
// sales for a small theater with a single one-night show. It uses data
// read in from the SeatAvailability.dat and SeatPrices.dat files, which
// are located in the same directory as this program. Students must be sure
// to place a copy of these two data files in their program project directory. 
