...
int getHighestDay(const double[], int);
int getLowestDay(const double[], int);
...
int main()
{
	...
	int highDay = getHighestDay(sales, NUM_DAYS);
	int lowDay = getLowestDay(sales, NUM_DAYS);
   ...
   cout << "The highest sales amount is $" << setw(9) << sales[highDay] << " on " << Day[highDay] << endl;
   cout << "The lowest sales amount  is $" << setw(9) << sales[lowDay]  << " on " << Day[lowDay] << endl;
...
//*****************************************************
// Definition of getHighestDay                           *
// This function finds and returns the day that had the highest value  *
// in the double array passed to it.                  *
//*****************************************************
int getHighestDay(const double array[], int size)
{
	double highest = array[0];
	int day = 0;
	for (int count = 1; count < size; count++)
...
//*****************************************************
// Definition of getLowestDay                            *
// This function finds and returns the day that had the smallest value *
// in the double array passed to it.                  *
//*****************************************************
int getLowestDay(const double array[], int size)
{
	double lowest = array[0];
	int day = 0;
	for (int count = 1; count < size; count++)
