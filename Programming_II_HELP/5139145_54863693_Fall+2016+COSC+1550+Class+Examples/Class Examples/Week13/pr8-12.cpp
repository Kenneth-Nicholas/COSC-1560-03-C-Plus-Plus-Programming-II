...
{
	char ch;
	int vowelCount = 0, yCount = 0, consonantCount;
	string sentence;
//	char sentence[81];
...
//	for (int pos = 0; sentence[pos] != '\0'; pos++)
//	for (int pos = 0; pos < 81; pos++)  // BAD !!!!
	{	
	...
	consonantCount = sentence.length() - vowelCount - yCount;
	cout << "There are " << sentence.length() << " characters in the sentence.\n";

	cout << "There are " << vowelCount << " vowels and " << yCount << " Y\'s in the sentence .\n";
	cout << "There are " << consonantCount << " consonants in the sentence.\n";
	return 0;
}
