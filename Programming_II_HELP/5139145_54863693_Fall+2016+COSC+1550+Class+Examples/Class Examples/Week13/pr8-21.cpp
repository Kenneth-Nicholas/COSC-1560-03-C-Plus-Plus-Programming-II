...
//*****************************************************************
void fillArray(double array[][ROWS_IN_SECTION][SEATS_IN_ROW], int SECTIONS, int ROWS, int SEATS)
{
	ifstream dataIn;
...
//*****************************************************************
void showArray(double array[][ROWS_IN_SECTION][SEATS_IN_ROW], int SECTIONS, int ROWS, int SEATS)
{
