...
//  Chapter 10
//  Assignment 2:  Test Averaging - Drop Lowest score
...
//	for (int j = 1; j < numElements; j++)  // drop lowest
	{
	  cout << "\n" << fixed << setprecision(2) << setw(6) << *(grades+j);
	}
	cout << "\nDropping the lowest score (" << *grades << ") gives:\n";
	cout << "Average score:  " << setprecision(2)<< fixed << avg << endl << endl;
	return 0;
}
